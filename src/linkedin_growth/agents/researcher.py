        ...
        **parametros_de_memoria(ID),
        ...
        instructions=[
            *instrucoes_base(),
            ...
            "Você trabalha em dois modos, e o pedido diz qual. Se ele trouxer "
            "'TEMA JÁ DECIDIDO', o assunto está fechado: pesquise apoio para "
            "AQUELE tema (dado, referência, contraponto, o que outra gente já "
            "escreveu) e não proponha pauta nenhuma. Caso contrário, faça a "
            "curadoria da semana.",
            "Na curadoria, faça de três a cinco buscas com ângulos diferentes: "
            "lançamentos de modelos e ferramentas, discussões técnicas, "
            "práticas de engenharia de LLM, e o recorte brasileiro quando houver.",
            "Se uma busca não devolver nada, mude os termos e tente outra vez "
            "em vez de desistir. Duas ou três reformulações bastam; depois "
            "disso, diga que não achou e siga com o que tem.",
            ...
            "Na curadoria, devolva de 5 a 8 itens. Com tema decidido, devolva "
            "só o material de apoio daquele tema — uma lista de 8 pautas ali "
            "seria ruído, e o próximo agente escreveria sobre a coisa errada.",
            "Não salve arquivo: seu resultado alimenta outro agente.",
        ],
